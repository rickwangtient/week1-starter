...
SECRET_KEY = os.environ.get(
    'SECRET_KEY',
    'django-insecure-)_!bg6)mxs8($_+u@kg&&pt5s1-ywe3a8g%&k=fbu(*w)yxbaz'
)
...
# Referrer Policy settings (allows OpenStreetMap tile requests without 403 blocks)
...
DATABASES = {
    "default": {
        ...
        "NAME": os.environ.get("DATABASE_NAME", "hello_map_db"),
